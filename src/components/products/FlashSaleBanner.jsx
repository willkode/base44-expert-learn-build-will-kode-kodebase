...
import { isFlashSaleActive, getFlashSaleEndAt } from "@/lib/flashSale";
    ...
    >
      <div className="rounded-2xl bg-gradient-to-r from-[#f87171] via-[#fb923c] to-[#facc15] px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-5">
        <div className="flex items-center gap-3 text-center md:text-left">
          <Flag className="w-6 h-6 text-[#0a0f1e] shrink-0" />
          <div>
            <p className="font-sora font-extrabold text-lg md:text-xl text-[#0a0f1e] leading-tight">
              🎆 America's 250th Birthday Flash Sale — everything $2.50
            </p>
            <p className="text-sm text-[#0a0f1e]/80 font-medium">Today only. Ends 11:59pm CST.</p>
          </div>
        </div>
