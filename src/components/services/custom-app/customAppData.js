...
export const faqs = [
  { q: "How much does a custom app cost?", a: "Custom app creation starts at $2,000. Final pricing depends on the number of features, entities, user roles, integrations, and how much AI or automation is involved. You get a fixed quote in writing before any work begins." },
  { q: "How long does a build take?", a: "Most builds run two to six weeks depending on scope. Smaller internal tools can be faster; larger multi-role platforms with payments and integrations take longer. Your timeline is confirmed with your quote." },
  { q: "What is it built with?", a: "Your app is built on Base44 — React frontend, entity database, backend functions, workflows, and integrations — so it's fast to build, easy to extend, and simple to hand off." },
  { q: "Do I own the app?", a: "Yes. The app lives in your Base44 account and the code and data are yours. Full documentation and a walkthrough are included at handoff." },
  { q: "Can you finish an app I already started?", a: "Yes. Existing builds are welcome. We review what's there, fix what needs fixing, and complete the rest to spec." },
  { q: "Can you add payments, email, or AI features?", a: "Yes. Payments, transactional email, SMS, AI features, agents, scheduled automations, and third-party API integrations are all standard options." },
  { q: "What do you need from me to start?", a: "A description of what the app should do and who uses it. If you have a spec, wireframes, or a document, even better — the scope call turns whatever you have into a clear plan." },
  { q: "What happens after launch?", a: "You can take it from there, or continue with KodeCare monthly support for bug fixes, new features, and ongoing maintenance." },
];