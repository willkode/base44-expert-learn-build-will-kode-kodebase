...
export const faqs = [
  ...
  { q: "How is migration pricing determined?", a: "We rebuilt our Base44 backend and automated the migration process, which let us drop pricing from $2,000 per migration to a starting price of $199. Applications with fewer than 100 pages and backend functions combined migrate for a flat $199 and can be paid for immediately. Applications above that threshold receive a custom quote on a short call, based on entities, backend functions, authentication complexity, user roles, data volume, payments, external APIs, realtime functionality, storage, automations, AI features, and deployment architecture." },
  { q: "Why did migration pricing drop from $2,000 to $199?", a: "The original price reflected the manual engineering required for every migration. We have since rebuilt the Base44-compatible backend and automated discovery, schema conversion, function migration, and deployment setup. That automation removed most of the repeated manual work, so standard migrations now start at $199." },
];