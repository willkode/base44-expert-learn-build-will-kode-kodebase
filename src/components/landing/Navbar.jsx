...
import { Menu, X, ChevronDown, FileText, BookOpenCheck, Sparkles, Library, Settings2, ShieldCheck, Wand2, Headphones, Wrench, Shield, TrendingUp, Heart, ArrowRight, BookOpen, Database, Rocket, Hammer, MonitorDown, GraduationCap, Stethoscope, Boxes, Mail } from "lucide-react";
...
const toolItems = [
  { label: "KodeMail", to: "/products/kodemail", icon: Mail, desc: "Business email on your own domain — no DNS setup, $25 lifetime", badge: "NEW" },
