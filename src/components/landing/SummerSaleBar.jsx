...
export default function SummerSaleBar() {
  ...
  return (
    <Link
      to="/products"
      onClick={() => trackCTA({ text: "Will's Birthday Sale 86% off", location: "promo_bar", destination: "/products" })}
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-10 flex items-center justify-center gap-2 text-center text-xs sm:text-sm font-semibold">
        ...
        <span>
          Will's Birthday Sale — <span className="font-extrabold">86% off all products</span>. Ends {SUMMER_SALE_END_LABEL}.
        </span>
